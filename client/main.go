...
var (
	jwtSet *jwk.Set
	host   = flag.String("host", "https://0b73-2600-4040-2098-a700-d427-90ae-f6d1-2ddd.ngrok.io", "Host URL for the remote API server")
...
func main() {
	...
	jwksURL := fmt.Sprintf("%s%s", *host, "/openid/v1/jwks")
